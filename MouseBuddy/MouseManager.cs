...
namespace MouseBuddy
{
    ...
    public class MouseManager : BaseInputManager, IMouseManager
    {
        ...
        public IntStateMachine LeftButtonState
        {
            get; private set;
        }

        public IntStateMachine RightButtonState
        {
            get; private set;
        }
        ...
        private void OnLButtonStateChange(Object obj, StateChangeEventArgs<int> e)
        {
            OnButtonStateChange(e.OldState, e.NewState, MouseButton.Left);
        }

        private void OnRButtonStateChange(Object obj, StateChangeEventArgs<int> e)
        {
